      ...
      <ScrollView
        ...
        <TouchableOpacity
          ...
          style={{
            ...
            marginTop: 15,
            marginBottom: 5,}} >
          <Icon name="comment-edit-outline" size={40} color={'#7841e9'} />
        ...
        <View>
          <View style={styles.userInfoSection}>
            ...
            <View style={{justifyContent: 'center', alignItems: 'center'}}>
              ...
              <Caption style={styles.caption}>@{feedbackData.lastname}</Caption>
            </View>
          </View>
        </View>
        <View style={styles.userInfoSection}>
          <View style={styles.row}>
            <View style={styles.textBox}>
              <Icon name="account" color="#665444" size={25} />
              <Text style={{color: '#665444', marginLeft: 20}}>{name}</Text>
            </View>
          </View></View>
        <View style={styles.userInfoSection}>
          <View style={styles.row}>
          ...
          <View style={styles.row}>
            <View style={styles.textBox}>
              <Icon name="comment" color="#665444" size={25} />
              <Text style={{color: '#665444', marginLeft: 20}}>
                {feedbackData.comment ? feedbackData.comment : 'No feedback yet'}
              </Text>
            </View>
          </View>
        </View>
