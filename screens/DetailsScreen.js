      ...
      <View style={{height: 400, backgroundColor: COLORS.background}}>
        ...
        <View style={style.detailsContainer}>
          ...
          <View style={{flexDirection: 'row', justifyContent: 'space-between'}}>
            ...
            <Icon name="assistant" size={25} color={COLORS.grey} />
          </View>
      ...
      <View style={{marginTop: 80, justifyContent: 'space-between', flex: 1}}>
        <View>
          ...
          <View style={{flexDirection: 'row', paddingHorizontal: 20}}>
            ...
            <Text style={{color: COLORS.grey, fontSize: 12}}>May 12, 2022</Text>
          </View>
          <Text style={style.comment}>
            Finished my Diploma so I am offering to lend my book for others education purposes. 
